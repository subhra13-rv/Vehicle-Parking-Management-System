        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <tr>
					...
					<td>
					<center>
                        <img width="50px" height="50px" src="<?php echo $row['qr_img']; ?>" /><br />
                        <small><?php echo 'PRK_'.$row['ID']; ?></small>
                    </center>
					</td>
					...
					<td><a href="view-incomingvehicle-detail.php?viewid=<?php echo $row['ID'];?>">View</a> 
					  <a href="print.php?vid=<?php echo $row['ID'];?>" style="cursor:pointer" target="_blank">Print Report</a>
					</td>
                </tr>
                <?php 
$cnt=$cnt+1;
