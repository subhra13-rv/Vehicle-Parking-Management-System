                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Total Number Vehicle Entries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-heading">
												<b><i>Contact Information</i></b><br>
												1.&nbsp;&nbsp;Manager:&nbsp;&nbsp;033-2543-9510<br>
												2.&nbsp;&nbsp;Security Head:&nbsp;&nbsp;033-2543-9510<br>
												3.&nbsp;&nbsp;System Admin:&nbsp;&nbsp;033-2543-9510<br>
												4.&nbsp;&nbsp;FIRE:&nbsp;&nbsp;5555 or 7553<br>
												5.&nbsp;&nbsp;Base Camp:&nbsp;&nbsp;3573&nbsp;&nbsp;(ex. 2)
											</div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-heading">
												<div style="text-align:center;padding:1em 0;"> <h5><a style="text-decoration:none;" href="https://www.zeitverschiebung.net/en/city/1275004"><span style="color:gray;">Time Now</span></a></h5> <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=en&size=small&timezone=Asia%2FKolkata" width="100%" height="90" frameborder="0" seamless></iframe> </div>
											</div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-heading">
												<b><i>For Emergency Contact dial</i></b><br>
												1.&nbsp;&nbsp;1004<br>
												2.&nbsp;&nbsp;2525-2323<br>
												3.&nbsp;&nbsp;2525-2222<br>
												4.&nbsp;&nbsp;9875&nbsp;&nbsp;(ex. 102)<br>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-heading">
												<marquee style="padding-top: 5px; font-size:20px;"><b style="color: red;">COVID 19 ALERT:&nbsp;</b>This message library, provided by WHO, is intended to be locally adapted and delivered to the general public in countries around the world via SMS or voice message. Member States are encouraged to localize and translate the messages below as necessary. WHO and ITU have called on all telecommunications companies worldwide to support the delivery of these messages and unleash the power of communication technology to save lives from COVID-19.</marquee>
											</div>
                                        </div>
                                    </div>
