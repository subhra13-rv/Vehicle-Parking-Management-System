...
if (strlen($_SESSION['vpmsaid']==0)) {
  header('location:logout.php');
	...
	if(isset($_POST['submit']))
	  {
		$parkingnumber=mt_rand(11111111, 99999999);
		...
		$c = (string)$parkingnumber;
		$text = $c."_NO_".$vehreno."_INTIME_".$enteringtime;
		
		$query=mysqli_query($con, "insert into  tblvehicle(ParkingNumber,VehicleCategory,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber,Status) value('$parkingnumber','$catename','$vehcomp','$vehreno','$ownername','$ownercontno','In')");
		if ($query) {
